		...
		<!-- 본문 세로2행 -->
	      ...
	      <div class="row top_bottom_blank">
	        ...
	        <div class="col-sm-2">
	        	...
	        	<a href="#"><button type="button" class="btn btn-block btn-default">온라인 예약</button></a>
	        	<a href="#"><button type="button" class="btn btn-block btn-default">예약 확인 및 취소</button></a>
	        </div>
	        <div class="col-sm-2">
	        ...
	        <div class="col-sm-2">
	        	...
	        	<a href="#"><button type="button" class="btn btn-block btn-default">공지사항</button></a>
	        	<a href="#"><button type="button" class="btn btn-block btn-default">자주 묻는 질문</button></a>
	        	<a href="#"><button type="button" class="btn btn-block btn-default">Q&A</button></a>
	        </div>
	        <div class="col-sm-2">
	        	<button type="button" class="btn btn-block btn-primary">병원안내</button><br/>
	        	<a href="#"><button type="button" class="btn btn-block btn-default">병원 소개</button></a>
	        	<a href="#"><button type="button" class="btn btn-block btn-default">병원 소식</button></a>
	        </div>
	        <div class="col-sm-2">
	        	<button type="button" class="btn btn-block btn-primary">회원서비스</button><br/>
	        	<a href="#"><button type="button" class="btn btn-block btn-default">마이페이지</button></a>
	        	<a href="#"><button type="button" class="btn btn-block btn-default">진료기록</button></a>
	        	<a href="#"><button type="button" class="btn btn-block btn-default">로그인</button></a>
	        	<a href="#"><button type="button" class="btn btn-block btn-default">회원가입</button></a>
	        </div>
	        <div class="col-sm-1"></div>
	      </div>
  	 	</div>
